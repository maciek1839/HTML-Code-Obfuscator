export default function generateHTML(config){
    let headerCount=config.headers;
    let paragraphCount=config.paragraphs;
    let buttonCount=config.buttons;
    let linkCount=config.links;
    let inputCount=config.inputs;
    let selectCount=config.images;
    let elementsList = [
